...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="c:/Users/GG2Admin/Documents/Refference Code/1.Python/1.Zelda Python Game/code/login_regi/regi_main.jpg")
        bg=Label(self.root,image=self.bg).place(x=250,y=0,relwidth=1,relheight=1)
        
        # Left Image
        self.left=ImageTk.PhotoImage(file="c:/Users/GG2Admin/Documents/Refference Code/1.Python/1.Zelda Python Game/code/login_regi/login_left.png")
        ...
        self.btn_img=ImageTk.PhotoImage(file="c:/Users/GG2Admin/Documents/Refference Code/1.Python/1.Zelda Python Game/code/login_regi/Regi_Button.jpg")
        btn_register=Button(frame1,image=self.btn_img,bd=0,cursor="hand2",command=self.register_data).place(x=50,y=420)
        
        # Login Button
        btn_login=Button(self.root,text="Sign In",command=self.login_window, font=("time new roman",20),bd=0,cursor="hand2").place(x=200,y=500,width=180)
